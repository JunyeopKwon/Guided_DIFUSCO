...
def arg_parser():
  ...
  parser.add_argument('--storage_path', type=str, default="/home/user/Desktop/kjy/DIFUSCO/data")
  parser.add_argument('--training_split', type=str, default="/home/user/Desktop/kjy/DIFUSCO/data/difusco_data/tsp200_test_concorde.txt")
  ...
  parser.add_argument('--validation_split', type=str, default="/home/user/Desktop/kjy/DIFUSCO/data/difusco_data/tsp200_test_concorde.txt")
  parser.add_argument('--test_split', type=str, default="/home/user/Desktop/kjy/DIFUSCO/data/difusco_data/tsp200_test_concorde.txt")
  ...
  parser.add_argument('--guided', type=str, default=None) # choices=['farthest_c', 'Christofides_c', ...]
  parser.add_argument('--guided_noise', type=int, default=650) #Greedy: 650, Sampling: 750.
  ...
  parser.add_argument('--sequential_sampling', type=int, default=4)
  ...
  parser.add_argument('--ckpt_path', type=str, default="/home/user/Desktop/kjy/DIFUSCO/data/difusco_ckpts/tsp100_categorical.ckpt")
